...
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link" href="user_dashboard.php">Beranda <span class="sr-only"></span></a>
              </li>
              <li class="nav-item">
        ...
        <!-- Search bar -->
        <form class="search-bar-container d-md-flex d-none" method="GET" action="user_dashboard.php">
...
<div class="col-md-4">
    <div class="card mb-3">
          <div class="card-body">
            ...
            <ul class="list-group">
              <li class="list-group-item"><a href="user_dashboard.php?kategori=politik">#Politik</a></li>
              <li class="list-group-item"><a href="user_dashboard.php?kategori=olahraga">#Olahraga</a></li>
              <li class="list-group-item"><a href="user_dashboard.php?kategori=teknologi">#Teknologi</a></li>
              <li class="list-group-item"><a href="user_dashboard.php?kategori=agama">#Agama</a></li>
              <li class="list-group-item"><a href="user_dashboard.php?kategori=movie">#Movie</a></li>
              <li class="list-group-item"><a href="user_dashboard.php?kategori=otomotif">#Otomotif</a></li>
